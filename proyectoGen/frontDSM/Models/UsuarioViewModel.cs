...
namespace frontDSM.Models
{
    public class UsuarioViewModel
    {
        ...
        [Display(Prompt = "Su contraseña", Description = "Su contraseña", Name = "Contraseña")]
        [Required(ErrorMessage = "Debe indicar una contraseña para su usuario")]
        [StringLength(maximumLength: 50, ErrorMessage = "Sus contraseña no puede superar los 20 caracteres", MinimumLength = 6)]
