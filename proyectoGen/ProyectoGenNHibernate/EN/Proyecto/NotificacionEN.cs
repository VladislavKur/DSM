...
public NotificacionEN(int id, ProyectoGenNHibernate.Enumerated.Proyecto.TipoNotificacionEnum tipo, string contenido, int id_tipo, ProyectoGenNHibernate.EN.Proyecto.SesionEN sesion
                      )
{
...
private void init (int id
                   , ProyectoGenNHibernate.Enumerated.Proyecto.TipoNotificacionEnum tipo, string contenido, int id_tipo, ProyectoGenNHibernate.EN.Proyecto.SesionEN sesion)
{
        this.Id = id;
