...
public static void InitializeData ()
{
        ...
        try
        {
                ...
                try {
                        int match1 = matchCEN.New_ (EstadoMatchEnum.pendiente, idUsu, idUsu2);
                        MatchEN matchEN1 = new MatchCAD ().ReadOIDDefault (match1);
                        int match2 = matchCEN.New_ (EstadoMatchEnum.aceptado, idUsu2, idUsu);
                        MatchEN matchEN2 = new MatchCAD ().ReadOIDDefault (match1);

                        matchCP.HacerMatch (match1, idUsu, idUsu2);
                }
                catch (Exception e)
                {
                ...
                int idmen1 = men1.New_ (" algo de contenido", EstadoMensajeEnum.pendiente, idUsu, idUsu2);
                MensajeCEN men2 = new MensajeCEN ();
                int idmen2 = men2.New_ (" a si, que guay ", EstadoMensajeEnum.pendiente, idUsu2, idUsu);

                MensajeEN mensajeEN1 = new MensajeCAD ().ReadOIDDefault (idmen1);
